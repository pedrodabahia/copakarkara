    ...
    >
      ...
      <div
        className={`absolute inset-0 transition-all duration-300
          ${colors[colorBg as keyof typeof colors]}
      ...
      <div
        className={`absolute inset-0 opacity-0 transition-all duration-300
          ${colors20[colorBg as keyof typeof colors20]}
          group-hover:opacity-100
        `}
      ></div>

      {/* conteúdo */}
      <div className="relative group-hover:opacity-0 z-10 flex flex-col justify-center h-full text-center text-white transition-all duration-300">
        <h2
          className="text-base sm:text-lg md:text-4xl font-bold px-2"
